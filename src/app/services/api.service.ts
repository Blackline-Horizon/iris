...
export class ApiService {
  ...
  getHermes(endpoint: string = '', params: Record<string, any> = {}): Promise<AxiosResponse<any>> {
    return axios.get(environment.HERMES + endpoint, { params }) // Pass params as the second argument
